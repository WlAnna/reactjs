  ...
  render() {
    ...
    return (
      <div className='Hangman'>
        <h1>Hangman</h1>
        <img src={this.props.images[this.state.nWrong]} alt={this.state.nWrong + '/' + this.props.maxWrong + ' wrong'} />
        ...
        {this.state.nWrong === this.props.maxWrong ? <p>'You are looser!'</p> : <p className='Hangman-btns'>{this.generateButtons()}</p>}
